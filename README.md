...
[![Ver Portfólio](https://img.shields.io/badge/Acessar%20Site-GitHub%20Pages-blue?style=for-the-badge&logo=github)](https://gabrie1tk.github.io/portfolio/)
...
* **Sobre mim:** Breve apresentação pessoal e resumo profissional.
* **Skills:** Visualização das minhas competências (HTML, CSS, JavaScript, etc.).
* **Hobbies:** Interesses pessoais que complementam meu perfil.
* **Formação:** Linha do tempo ou lista dos meus cursos e graduações.
...
* **HTML5:** Uso de tags semânticas (`<header>`, `<section>`, `<footer>`) para melhor acessibilidade e SEO.
* **CSS3:**
    * **Flexbox:** Para alinhamento e distribuição dos elementos na tela.
    * **Variáveis CSS (`:root`):** Para gerenciamento consistente da paleta de cores.
...
1.  **Clone o repositório:**
    ```bash
    git clone [https://github.com/Gabrie1Tk/portfolio.git](https://github.com/Gabrie1Tk/portfolio.git)
    ```
2.  **Entre na pasta:**
    Navegue até o diretório do projeto.
3.  **Abra o navegador:**
    Dê um duplo clique no arquivo `index.html` ou use uma extensão como o *Live Server*.
